...
(function (jQuery, ytp) {
	...
	jQuery.browser.ios = /iPhome|iPad|iPod|webOS/i.test(nAgt);
	jQuery.browser.operaMobile = /Opera Mini/i.test(nAgt);
	jQuery.browser.kindle = /Kindle|Silk/i.test(nAgt);
	jQuery.browser.windowsMobile = /IEMobile|Windows Phome/i.test(nAgt);
	...
	jQuery.mbYTPlayer = {
		...
		defaults: {
			...
			addRaster              : true,
			opacity                : 1,
			quality                : "small", //or “small”, “medium”, “large”, “hd720”, “hd1080”, “highres”
			mute                   : true,
			loop                   : true,
			showControls           : false,
